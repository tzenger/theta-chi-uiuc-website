...
export const weeklyFineReports: FineReport[] = [
  ...
  { semesterWeek: '06', status: FineReportStatus.FINALIZED, startDate: new Date('2/24/2020'), endDate: new Date('3/1/2020'), events: undefined, attendances: undefined },
  { semesterWeek: '07', status: FineReportStatus.PENDING, startDate: new Date('3/2/2020'), endDate: new Date('3/8/2020'), events: undefined, attendances: undefined },
  { semesterWeek: '08', status: FineReportStatus.CURRENT, startDate: new Date('3/9/2020'), endDate: new Date('3/15/2020'), events: undefined, attendances: undefined },
