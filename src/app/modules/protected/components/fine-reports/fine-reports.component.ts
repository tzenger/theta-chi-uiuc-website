...
export const weeklyFineReports: FineReport[] = [
  ...
  { status: FineReportStatus.PENDING, startDate: new Date('2/17/2020'), endDate: new Date('2/23/2020'), events: undefined, attendances: undefined },
  { status: FineReportStatus.CURRENT, startDate: new Date('2/24/2020'), endDate: new Date('3/1/2020'), events: undefined, attendances: undefined },
